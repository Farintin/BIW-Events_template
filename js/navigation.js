jQuery(document).ready(function($) {
    ...
    $('.nav-link').on('click', function(event) {
        ...
        var section = $($(this).attr('href'));
  	    ...
  	    $('html, body').animate({scrollTop: sectionOffset.top - navHeight}, 1000, "easeInOutExpo");
    ...
    $('#mobileNavToggler').click(function () {
      ...
      if ( $('#navTop').hasClass('closed-sm') ) {
        $('#navTop').removeClass('closed-sm');
        $(this).addClass('close')
      } else {
        $('#navTop').addClass('closed-sm');
    ...
    // Selecting active Social-Posts section view
